...
var activateLists, alignChildren, checkResize, elements, getPlatform, init, makeSquare, rows;
...
rows = {
  'mod-row': ['card', 'tile'],
  'mod-lists .list-item': ['pull-left', 'pull-right', 'text']
};
